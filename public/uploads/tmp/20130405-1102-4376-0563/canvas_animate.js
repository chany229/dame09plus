$(function(){
	...
	var Shape = function(x, y, width, color){
		this.x = x;
		this.y = y;
		this.width = width;
		this.color = color;
	...
	for(var i = 0; i < 100; i++){
		var x = (Math.random() * canvas_width) - canvas_width;
		var y = Math.random() * canvas_height;
		var width = alpha = Math.random() * 50;
		shapes.push(new Shape(x, y, width, "rgba(0,0,0,"+ alpha/50.0 +")"));
	}
